import processNoteHeadings from "./noteHeadings.js";
...
export function normalizeNote(note) {
  ...
  const headings = processNoteHeadings(contentHtml);
  ...
  return {
    ...
    content_html: headings.content_html,
    toc: headings.toc,
    reading_time_minutes: readingTimeMinutes,
    reading_time_text: `${readingTimeMinutes} min read`,
  };
}
